...
<body>
	<div class="container-fluid">
		...
		<div class="container-fluid justify-content-between container-nav">
			<a class="navbar-text" href="#"><h3>История займов и погашений</h3> </a>
										...
										<tbody id="group-of-rows-1" class="collapse">
											<tr>
												<td colspan="9" class="collapse-table">
													<p><span>ID партнера:</span>108562529834823</p>
													<p><span>Партнер:</span><span class="lilac">"МВидео"</span></p>
													<p><span>Value (сумма полученных бонусов):</span>32 000.00 RLC</p>
													<p><span>Value (Сумма списанных бонусов):</span>32 000.00 RLC</p>
													<p><span>Value (Сумма бонусов в накопление):</span>32 000.00 RLC</p>
												</td>
											</tr>
										</tbody>
									</div><!--tbody-td-->
