...
<head>
	...
	<title>FAQ RUCOIN LOYALTY</title>
	<meta name="keywords" content='faq, вопросы и ответы' />
    <meta name="description" content='FAQ RUCOIN LOYALTY - ответы на самые значисые вопросы blockchain, rucoin и rucoin loyalty.' />
										...
										<div class="col-lg-12 page-body">
											...
											<div id="accordion">
												<div class="card">
													<div class="card-header" id="headingOne">
														<h5 class="mb-0">
															...
															Сколько всего выпущено токенов Rucoin?</br>
														</button>
													</h5>
												</div>
												...
												<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
													<div class="card-body">
														Единоразовая эмиссия токенов в количестве 500 000 000 токенов.
													</div>
												</div>
											</div>
											<div class="card">
												<div class="card-header" id="headingTwo">
													<h5 class="mb-0">
														<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
															Какой используется механизм консенсуса?
														</button>
													</h5>
												</div>
												<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
													<div class="card-body">
														BFT делегированные узлы-валидаторы + DPoS делегированное доказательство доли.
													</div>
												</div>
											</div>
											<div class="card">
												...
												<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
													<div class="card-body">
														Стоимость транзакций фиксирована и составляет 0,01% от суммы транзакции.
													</div>
												</div>
											</div>
										</div>
