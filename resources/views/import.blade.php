	...
	<div class="container-fluid">
		...
		<div class="container-fluid justify-content-between container-nav">
			<ul class="navbar-text">
				...
				<li><a href="#">Импорт кошелька</a></li>
			</ul>
								...
								<div class="row">
									<div class="col-lg-12 import">
										<ul class="nav nav-tabs" id="myTab" role="tablist">
											<li class="nav-item">
												<a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Ключевое словосочетание</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Файл / Текст</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Аппаратный кошелек</a>
											</li>
										</ul>
												...
												<div class="row">
													...
													<form>
														<div class="form-textarea">
															<label for="formGroupExampleInput">Введите Ключевое Словосочетание<span>Обычно двенадцать слов</span></label>
															<a href="#"><img src="images/lk/textarea-btn.png" alt=""></a>
															<textarea class="form-control" id="exampleFormControlTextarea1" rows="1"></textarea>
														</div>
														<button class="punkt-dropdaun" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
														...
														<div class="form-group">
															<label for="formGroupExampleInput">Путь Деривации</label>
														...
														<button type="button" class="btn">Импорт</button>
													</form>
												...
												<div class="row">
													...
													<form>
														<div class="form-group form-group-file">
															<label for="exampleFormControlFile1">Выберите файл резервной копии</label>
													...
													<div class="card card-body">
														...
														<button type="button" class="btn">Импорт резервной копии</button>
													</form>
												</div><!--col-lg-3 lk-form-->
												</div><!--row-->
											</div><!--tab-pane-->
											<div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
												<div class="row">
													<div class="col-lg-4 lk-form">
														...
														<div class="form-group">
															<label for="formGroupExampleInput">Wallet Type</label>
															<input type="email" class="form-control" id="formGroupExampleInput" placeholder="" name="text">
														</div>
														<div class="form-group">
															<label for="formGroupExampleInput">Номер Аккаунта</label>
															<input type="email" class="form-control" id="formGroupExampleInput" placeholder="" name="text">
														</div>
															<div class="center">
															<div class="form-check">
														...
														<button class="punkt-dropdaun" type="button" data-toggle="collapse" data-target="#collapseExample3" aria-expanded="false" aria-controls="collapseExample3">
															дополнительные настройки
														</button>
