					...
					<div class="row">
						...
						<div class="textwidget">
							...
							<div class="lk-content container-fluid">
								<div class="row">
									<div class="col-lg-4 options-form">
										<div class="form-group form-select">
											<label for="formGroupExampleInput">Язык</label>
											<select id="inputState" class="form-control">
												<option selected>Русский</option>
												<option>Русский2</option>
												<option>Русский3</option>
												<option>Русский4</option>
											</select>
										</div>
										<div class="form-group form-select">
											<label for="formGroupExampleInput">Единица измерения</label>
											<select id="inputState" class="form-control">
												<option selected>RLC</option>
												<option>RLk</option>
												<option>RLA</option>
												<option>RLS</option>
												<option>RLD</option>
										...
										<div class="center">
											<div class="form-check">
												...
												<label class="form-check-label" for="inlineFormCheck">
													Использовать неподтвержденные средства
												</label>
											</div>
										</div>
										<button type="button" class="btn">О КРИПТОВАЛЮТЕ ЛОЯЛЬНОСТИ</button>
