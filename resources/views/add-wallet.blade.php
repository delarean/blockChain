...
<body>
	<div class="container-fluid">
		<div class="row">
			@include('sidebar')
			<div class="col-lg-10 lk-body add-wallet-wrap">
				...
				<div id="box" class="col-lg-12" style="display: none;">
					...
					<div class="row">
						...
						<div class="textwidget">
							...
							<div class="add-wallet container-fluid">
								<div class="row">
									<div class="col-lg-4">
										
										<a href="{{route('newWallet')}}">Создать новый кошелек</a>
										<a href="join.html">Присоединиться к общему кошельку</a>
										<a href="import.html">Импорт кошелька</a>
