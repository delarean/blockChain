					...
					<div class="row">
						...
						<div class="textwidget">
							...
							<div class="lk-content container-fluid">
								<div class="row">
									<div class="col-lg-4 options-blok">
										<a href="{{route('walletIdent')}}" class="options-kart">
											<h5>Идентификация (KYC)</h5>
											<span>Комментарий</span>
										</a>
										<a href="#" class="options-kart">
										...
										<div class="center">
											<div class="form-check">
												...
												<label class="form-check-label" for="inlineFormCheck">
													Запрашивать платежный пароль
												</label>
											</div>
										</div>
										<a href="#" class="options-kart">
											<h5>Удалить ключевое словосочетание</h5>
											<span>Необходимо создать резервную копию</span>
										</a>
