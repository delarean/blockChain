	...
	<div class="container-fluid">
		...
		<div class="container-fluid justify-content-between container-nav">
			<ul class="navbar-text">
				...
				<li><a href="#">Создать новый кошелек</a></li>
			</ul>
              ...
              <a href="https://bitcointalk.org/index.php?topic=2534183" class="dropdown-item" target="_blank">BitcoinTalk</a>
		          <a href="https://en.wikipedia.org/wiki/RuCoin" class="dropdown-item" target="_blank">Wikipedia</a>
					...
					<li class="nav-item dropdown lang-ico">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="#"><img src="{{asset('images/gb.png')}}" alt=""></a>
						</div>
					</li>
					<li class="nav-item dropdown">
					...
					<div class="row">
						...
						<div class="textwidget">
							...
							<div class="import-wrap container-fluid">
								<div class="row">
									<div class="col-lg-12 import">
										<ul class="nav nav-tabs" id="myTab" role="tablist">
											<li class="nav-item">
												<a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Личный кошелек</a>
											</li>
											<li class="nav-item">
												<button class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Общий кошелек</button>
											</li>
										...
										<div class="tab-content" id="myTabContent">
											<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
												<div class="row">
													...
													<form method="POST" action="{{route('newPersonalWallet')}}">
														@csrf
														<div class="form-group">
															<label for="formGroupExampleInput">Название Кошелька</label>
															<input type="text" class="form-control" id="formGroupExampleInput" placeholder="" name="wallet_name">
														</div>
													@if($errors->personal->has('wallet_name'))
                                                <div>{{$errors->personal->first('wallet_name')}}</div>
													@endif
														

														<button class="punkt-dropdaun" type="button" data-toggle="collapse" data-target="#collapseExample1" aria-expanded="false" aria-controls="collapseExample1">
													...
													<div class="card card-body">
														...
														<button type="submit" class="btn">Создать новый кошелек</button>
													</form>
											...
											<div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
												<div class="row">
													<div class="col-lg-4 lk-form">
													<form method="POST" action="{{route('newSharedWallet')}}">
														@csrf
														<div class="form-group">
															<label for="formGroupExampleInput">Название Кошелька</label>
															<input type="text" class="form-control" id="formGroupExampleInput" placeholder="" name="wallet_name">
														</div>
													@if($errors->shared->has('wallet_name'))
                                                <div>{{$errors->shared->first('wallet_name')}}</div>
													@endif

														<div class="form-group">
															<label for="formGroupExampleInput">Ваше Имя</label>
															<input type="text" class="form-control" id="formGroupExampleInput" placeholder="" name="user_name">
														</div>
													@if($errors->shared->has('user_name'))
                                                <div>{{$errors->shared->first('user_name')}}</div>
													@endif

														<div class="form-group form-select">
															<label for="formGroupExampleInput">Количество Совладельцев</label>
															<select id="inputState" class="form-control">
														...
														<div class="form-group form-select">
															<label for="formGroupExampleInput">Требуемое Число Подписей</label>
															<select id="inputState" class="form-control">
																<option selected>1</option>
																<option>2</option>
																<option>3</option>
														...
														<button class="punkt-dropdaun" type="button" data-toggle="collapse" data-target="#collapseExample6" aria-expanded="false" aria-controls="collapseExample6">
															дополнительные настройки
														</button>
...
tbody.collapse.in {
  display: table-row-group;
							...
							<script>
								(function($) {
									$(function() {
										$('.modal-content input,.modal-content select,.form-group-file input,.form-select select').styler({
											selectSearch: true,
										});
									});
								})(jQuery);
												...
												@if(Session::has('wallet'))
													<script>
                                                        alert("Кошелёк успешно создан,ваш адрес - {{Session::get('wallet')->text_address}}");
													</script>
													@endif
