...
<head>
	...
	<title>DONATIONS RUCOIN LOYALTY</title>
	<meta name="keywords" content='donations' />
    <meta name="description" content='Краудфандинговая площака Boomstarter.ru совместно с сообществом Rucoin привлекают спонсорскую поддержку проекта Rucoin Loyalty.' />
					...
					<div class="row">
						...
						<div class="textwidget">
							...
							<section class="wraper-blok page">
								...
								<div class="container">
									<h1>DONATIONS RUCOIN LOYALTY</h1>
									<div class="row">
										<div class="col-lg-12 page-body">
											
											DONATIONS RUCOIN LOYALTY
