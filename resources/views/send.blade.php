                   ...
                   <div class="col-lg-4 lk-form">
													<form>
														<div class="form-group form-send">
															<label for="formGroupExampleInput">Кому</label>
															<img src="images/lk/wallet-form.png" alt="">
														...
														<div class="form-textarea">
															<label for="formGroupExampleInput">Назначение платежа<span>Необязательно</span></label>
							...
							<div class="send-bottom container-fluid ">
								<div class="row justify-content-between">
										<a href="#" class="col"><i class="fa fa-download" aria-hidden="true"></i>Получить</a>
